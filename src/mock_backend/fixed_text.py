...
DYSLEXIA_RESPONSES = {"""<pulling in NHS data to answer your question> Here are some common Signs of Dyslexia:""": 0.9,
...
9. Understanding information when told verbally, but having difficulty with information that's written down""": 0.6,

"""Do your symptoms match these?""": 0.9
}
...
# DYSPRAXIA_RESPONSES = {
# "Bungee jumping is an extreme sport that involves leaping from a high structure—such as a bridge, crane, or tower—while connected to a strong elastic cord. As you jump, the cord stretches and absorbs your fall, creating a thrilling combination of free-fall and rebound. The experience is intense but brief, often lasting only a few seconds of pure weightlessness before the cord slows your descent and sends you bouncing upward.": 0.1,

# "The sport offers a unique mix of adrenaline and psychological challenge: it’s as much about confronting fear as it is about the physical sensation of falling. Safety is taken seriously, with professional operators using multi-strand latex cords, harnesses, and pre-jump health screenings to minimize risks. Bungee jumping has become popular worldwide, with iconic sites like the Kawarau Bridge in New Zealand, the Verzasca Dam in Switzerland, and the Macau Tower in China offering breathtaking heights and unforgettable views.": 0.1,

# "For many, the jump is transformative—a moment of exhilaration, courage, and freedom that lingers long after the cord has settled.": 0.1,

# }

DYSPRAXIA_RESPONSES = {
    "<pulling in NHS data to answer your question> Based on NHS information, here are the symptoms of dyspraxia (also known as Developmental Co-ordination Disorder or DCD) in children" : 0.9,
...
#     "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit..": 0.1,
...
CHATBOT_DESCRIPTION = "ChatGPT does not understand healthcare well. Talk to me instead, I have access to NHS data!"
